import Maxtrix2 from './Math/Matrix2.js'
...
export default class Canvas2 {
    constructor(width, height, shaderSources) {
        ...
        window.addEventListener('updateCanvas2', event => {
            setInterval(() => {
            this.updateCanvasHandler(event)
            }, 500)
        }, false);
        let rotatieSilderMatrix = document.getElementById('rotatieSilderMatrix');
    ...
    updateCanvasHandler(event) {
        ...
        this.clearData()
        {
            ...
            let maxtrixMath = document.getElementById('maxtrixMath').value;
            let rotatieSilderMatrix = document.getElementById('rotatieSilderMatrix');
            let subSliderMatrix = document.getElementById('subSliderMatrix');
    ...
    createCanvas() {
        ...
        document.getElementById("canvasDiv2").appendChild(canvas);
